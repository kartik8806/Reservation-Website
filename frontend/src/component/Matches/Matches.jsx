...
async function getmatches() {
    const response = await fetch('https://reservation-website-kappa.vercel.app/matches');
    return response.json();
}

async function getRole() {
    const response = await fetch('https://reservation-website-kappa.vercel.app/userRole', {
        credentials: 'include'
    });
